<%@ Page Title="" Language="C#" MasterPageFile="~/PostLogin.Master" AutoEventWireup="true" CodeBehind="NewStudio.aspx.cs" Inherits="Press3.UI.NewStudio" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Press3 - New Studio</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="page-content">
        <div class="portlet lite">
            <div id="ivr-layout">
                <div class="controls_row row-fluid">
                    <div class="span9">
                        ...
                        <ul id='ivr-toolbar' class="sub-menu" style="display: block;">
                            ...
                            <li name="Voice mail" id='voice'>
                                ...
                                <%--</li> <li name="Conference" id='conf' style="display: none;">
				<i class="icon-group" style="color:#e987ff"></i> 
				...
				<span>Record message</span>
                    ...
                    <div class="span3">
                        <%-- <div class="btn_ivr_save" style="margin-top:80px">
            <a id='save-btn' class="btn green button-next" href="javascript:void(0);">Save
            <i class="m-icon-swapright m-icon-white"></i></a></div>
            </div>--%>
                        <div class="drag_arrow" style="margin-left: 20px;">
        ...
        <div class="btn_ivr_save" style="margin-top: 30px;">
            <a id='draft-btn' class="btn blue" href="javascript:void(0);" style="cursor: pointer;" isdraft="1">Save as draft
               <i class="m-icon-swapright m-icon-white"></i></a>

            <a id='save-btn' class="btn green button-next" href="javascript:void(0);" style="cursor: pointer;" isdraft="0">Save
               <i class="m-icon-swapright m-icon-white"></i></a>
    ...
    <div id='del_cnfm_control' role="dialog" class="modal fade" data-keyboard="false">
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="margin-right-20">
                                    <input type="radio" name="radioCallType" value="1" checked="checked" />
                                    Outbound</label>
                                <label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript" src="scripts/custom/ivr-connection.js"></script>
    ...
    <script type="text/javascript" src="scripts/custom/new-studio.js?type=195"></script>
</asp:Content>
