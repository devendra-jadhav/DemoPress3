    ...
    $.jstree.core.prototype = {
        ...
        */
        redraw_node: function(node, deep, is_callback) {
            ...
            if (this.settings.core.force_text) {
                ...
                alert('for edit options menu')
            }
            else {
            if(obj.text == 'Contact Book'){ node.childNodes[1].innerHTML += obj.text + " <span class='group-submenu dropdown-toggle camenu' data-toggle='dropdown'> <i class='fa fa-ellipsis-v' ></i></span><ul class='dropdown-menu' id='cmenuul' style='margin-top:-10px;margin-left:100px;'> <li id='cmenuaddgroup'><a>Create New Group</a></li><li id='cmenuaddcontacts'><a>New Contacts</a></li></ul>";}
            else{
                node.childNodes[1].innerHTML += obj.text + " <span class='group-submenu'> <i class='fa fa-ellipsis-v cmenu'></i></span>";
                }
                        }
        ...
        */
        create_node: function(par, node, pos, callback, is_loaded) {
            ...
            if (!node) {  node = { "text": node }; }
           if(node != ''){ node = { "text": node };}
         
       
           if (node.text === 'undefined') { node.text = this.get_string('New node'); }
           else if (node.text == undefined) { node.text = this.get_string('New node'); }
           if (node.text === ''){ node.text = this.get_string('New node'); }
            var tmp, dpc, i, j;
               ...
               var inst = $.jstree.reference(data.reference),
                ...
                "create": {
                    ...
                    "action": function(data) {
                        ...
                        inst.create_node(obj, 'New node', "last", function(new_node) {
    ...
    $.jstree.plugins.contextmenu = function(options, parent) {
        ...
        this.bind = function() {
            ...
            this.element
				...
				.on("click.jstree", ".cmenu", $.proxy(function(e) {
				    e.preventDefault();
				   e.stopPropagation();
...
//				    }
        ...
        */
        this._show_contextmenu = function(obj, x, y, i) {
            ...
            $.vakata.context.show(a, { 'x': x + 100, 'y': y - 2}, i);
            /**
