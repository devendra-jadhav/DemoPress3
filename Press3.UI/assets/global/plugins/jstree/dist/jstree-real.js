    ...
    $.jstree.core.prototype = {
        ...
        */
        redraw_node: function(node, deep, is_callback) {
            ...
            node.childNodes[1].innerHTML += obj.text + " <span class='submenu-chkbox'> <input type='checkbox' id='chk_" + node.id + "' groupid='" + node.id + "' class='css-checkbox gropucheck'><label for='chk_" + node.id + "'  groupid='" + node.id + "' class='css-label checked'></label></span>";
